...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testbmp280: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testbmp280 ${OBJECTFILES} ${LDLIBSOPTIONS} -lglib-2.0

${OBJECTDIR}/MyLib/GeFunctions/geTime.o: MyLib/GeFunctions/geTime.c
	${MKDIR} -p ${OBJECTDIR}/MyLib/GeFunctions
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyLib/GeFunctions/geTime.o MyLib/GeFunctions/geTime.c

${OBJECTDIR}/MyLib/I2C/I2CLib.o: MyLib/I2C/I2CLib.c
	${MKDIR} -p ${OBJECTDIR}/MyLib/I2C
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyLib/I2C/I2CLib.o MyLib/I2C/I2CLib.c

${OBJECTDIR}/Sensors/BME280/bme280.o: Sensors/BME280/bme280.c
	${MKDIR} -p ${OBJECTDIR}/Sensors/BME280
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sensors/BME280/bme280.o Sensors/BME280/bme280.c

${OBJECTDIR}/Sensors/BME280/bme290_impl.o: Sensors/BME280/bme290_impl.c
	${MKDIR} -p ${OBJECTDIR}/Sensors/BME280
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sensors/BME280/bme290_impl.o Sensors/BME280/bme290_impl.c

${OBJECTDIR}/Server/json.o: Server/json.c
	${MKDIR} -p ${OBJECTDIR}/Server
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server/json.o Server/json.c

${OBJECTDIR}/TestBench.o: TestBench.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestBench.o TestBench.c

${OBJECTDIR}/Web_Server/mongoose.o: Web_Server/mongoose.c
	${MKDIR} -p ${OBJECTDIR}/Web_Server
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Web_Server/mongoose.o Web_Server/mongoose.c
...
${OBJECTDIR}/sqlite/sqldriver.o: sqlite/sqldriver.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sqlite/sqldriver.o sqlite/sqldriver.c

${OBJECTDIR}/sqlite/sqlite3.o: sqlite/sqlite3.c
	${MKDIR} -p ${OBJECTDIR}/sqlite
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sqlite/sqlite3.o sqlite/sqlite3.c
